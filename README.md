...
**v2.11.1 (Layout-native)**, is where development is focused now: it takes
...
|---|---|---|---|---|
| **v2.11.1 (Layout-native)**, latest | Native QGIS Layout item, no separate window, drops straight into Print Layout next to Legend/Scale Bar/Picture | Pending QGIS Plugin Repository approval, install manually via **Install from ZIP** for now | [`rasterviz-v2-layout-native/`](rasterviz-v2-layout-native/) | [RasterViz-v2-layout-native-2.11.1.zip](releases/RasterViz-v2-layout-native-2.11.1.zip) |
...
The newest release, **RasterViz v2.11.1 (Layout-native)**, is still
pending QGIS Plugin Repository approval, so for now it installs
manually:

1. Download [`releases/RasterViz-v2-layout-native-2.11.1.zip`](releases/RasterViz-v2-layout-native-2.11.1.zip)
